...
(function() {
  ...
  randomPlayer = function() {
    var index, index2, index3, index4, players, randomPlayer1, randomPlayer2, randomPlayer3, randomPlayer4;
    ...
    if (document.getElementById("assignTeam").checked === false) {
      ...
      return document.getElementById("blueTeam").innerHTML = randomPlayer3 + " & " + randomPlayer4;
    } else {
      document.getElementById("redTeam").innerHTML = "Offense: " + randomPlayer1 + " & " + "Defense: " + randomPlayer2;
      return document.getElementById("blueTeam").innerHTML = "Offense: " + randomPlayer3 + " & " + "Defense: " + randomPlayer4;
    }
  };
  ...
  $(function() {
    ...
    $('#new_game_button').on('click', function() {
      $(".modal").show();
      return $("#centered_form.new_game").show();
    });
    $("body").on('click', '.modal', function() {
      ...
      return $("#centered_form.edit-player").hide();
    });
    $('#new_player_button').on('click', function() {
      $(".modal").show();
      return $("#centered_form.new_player").show();
    });
    $('#random_game_button').on('click', function() {
      $(".modal").show();
      return $("#centered_form.random_game").show();
    });
    $('#new_season_button').on('click', function() {
      $(".modal").show();
      return $("#centered_form.season").show();
    });
    $('td.name').on('click', function() {
      var divSelector;
      divSelector = ".statistics[player_id=" + this.parentElement.id + "]";
      $(".modal").show();
      return $(divSelector).show();
    });
    $('.statistics .close').on('click', function() {
      $(".modal").hide();
      return $("#centered_form.statistics").hide();
    });
    $('.edit-player-link').on('click', function() {
      var divSelector;
